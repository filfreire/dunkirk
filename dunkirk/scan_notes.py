'''
 The original for scan_notes.py can be found at https://github.com/adamyi/notes_to_keep
 Thanks to @adamyi for the awesome work with the original repo 'notes_to_keep'
